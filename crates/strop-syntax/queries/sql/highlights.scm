; Vendored from Helix (runtime/queries/sql/highlights.scm, MPL-2.0).
; Trim vs Helix: keyword_rlike / keyword_refresh — absent from the
; tree-sitter-sequel 0.3.11 grammar (DerekStride); restore on a bump.
; Member access
(object_reference
