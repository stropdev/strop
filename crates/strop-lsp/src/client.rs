//! The LSP client: spawn, initialize, requests/notifications,
//! events onto the editor's channel. async_lsp behind this boundary
//! (0020: tokio stays in the service layer).
