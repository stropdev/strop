...
VARIABLES live,        \* set of live document ids
          ...
          misapplied   \* TRUE iff a delivery landed on a dead/stale doc
                       ...
                       \* without it is specs/EditorProtocol_Mutant.tla)
...
Deliver(r) ==
    ...
    /\ LET req == pendReq[r] IN
       ...
       IF req.doc \in live /\ rev[req.doc] = req.rev
       THEN applied' = applied \union {r} /\ misapplied' = misapplied
       ELSE applied' = applied /\ misapplied' = misapplied
